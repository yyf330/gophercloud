...
The following types satisfy this interface:
	...
	github.com/yyf330/gophercloud/openstack/identity/v2/tokens.CreateResult
	github.com/yyf330/gophercloud/openstack/identity/v3/tokens.CreateResult

Usage example:

	import (
		"github.com/yyf330/gophercloud"
		tokens2 "github.com/yyf330/gophercloud/openstack/identity/v2/tokens"
		tokens3 "github.com/yyf330/gophercloud/openstack/identity/v3/tokens"
	)
